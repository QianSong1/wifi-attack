...
5. 输入 : [sudo su] 回车提取root权限
   sudo su

![img_8.png](image/img_8.png)
7. 执行命令 [./fluxion.sh] 回车
   ./fluxion.sh
...
9. 选择一个你要破解的WiFi的序号，回车【绿色代表有人上网，可轻松抓包】
...
3. 鼠标左键单击桌面的 [wifi-hack] 文件夹 ,,, 然后 鼠标右键单击在这里打开终端

![img_37.png](image/img_37.png)
![img_38.png](image/img_38.png)
5. 输入 [sudo su] 提取root权限
   sudo su

![img_39.png](image/img_39.png)
7. 查看网卡【无线网卡一般叫wlan0..wlan1...等等】
   ip a
...
7. 再次查看网卡信息 [wlan0mon 就是监听模式下网卡的名字，记住它]
```shell
ip a
```
 ********************************************************
